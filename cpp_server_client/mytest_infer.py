#
# Example posting a POST request with an image to get the image classification from a deployed model (Resnet50)
#
...
try:
    ...
    #print("Found a ::" + classes_entries[int(mytext.strip("[]")) - 1] )
